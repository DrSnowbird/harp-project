...
class NoSyncCenMergeTaskOut {
  public NoSyncCenMergeTaskOut() {
  }
}

public class NoSyncCenMergeTask extends Task<Integer, NoSyncCenMergeTaskOut> {
  private final List<Map<Integer, DoubleArray>>  cenDataMaps;
  private final Map<Integer, DoubleArray> cenOutMap;

  public NoSyncCenMergeTask(List<Map<Integer, DoubleArray>> cenDataMaps,
  ...
  @Override
  public NoSyncCenMergeTaskOut run(Integer partitionID) throws Exception {
    ...
    return new NoSyncCenMergeTaskOut();
  }
}
